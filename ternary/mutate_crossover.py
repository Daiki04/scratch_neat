...
elitism = 2 # それぞれの種である世代から次の世代にコピーされるエリート個体の数
spice_elitism = 0 # 停滞から保護される種の数を示します。例えば3と設定すると、種の適応度の最も高い3つの種が、たとえ改善が示されなかったとしても、停滞により削除されなくなります。
...
max_stagnation = 15 # 種が停滞すると見なされる世代数
