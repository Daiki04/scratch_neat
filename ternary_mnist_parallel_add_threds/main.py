...
if __name__ == '__main__':
    ...
    while True:
        ...
        print(f'Generation: {generation}, Number of Species: {len(species_set.species)}, Best Genome: {best_genome_id}, Fitness: {best_genome.fitness}, Acc: {best_genome.acc}, Test Loss: {test_loss}, Test Acc: {test_acc}, compatibility_threshold: {species_set.compatibility_threshold}')
